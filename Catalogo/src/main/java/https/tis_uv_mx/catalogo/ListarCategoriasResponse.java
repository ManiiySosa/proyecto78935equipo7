...
// Generado el: 2022.06.01 a las 06:11:09 PM CDT 
//
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="categorias" maxOccurs="unbounded"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
...
@XmlRootElement(name = "listarCategoriasResponse")
public class ListarCategoriasResponse {

    @XmlElement(required = true)
    protected List<ListarCategoriasResponse.Categorias> categorias;
     ...
     * {@link ListarCategoriasResponse.Categorias }
     * 
     * 
     */
    public List<ListarCategoriasResponse.Categorias> getCategorias() {
        if (categorias == null) {
            categorias = new ArrayList<ListarCategoriasResponse.Categorias>();
        }
